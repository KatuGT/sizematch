    ...
    <div className="relative">
      <div className="mx-auto max-w-3xl p-2 text-white">
        <h2 className="mt-6 text-4xl font-bold">
          Cookie Policy for Size Match
        </h2>

        <p className="mb-1 text-xs">
          This is the Cookie Policy for Size Match, accessible from
          <Link href="/"> https://sizematch.net/</Link>
        </p>
        ...
        <ul>
          <li>Email: sizematchinfo@gmail.com</li>
        </ul>
      </div>
    </div>
  );
