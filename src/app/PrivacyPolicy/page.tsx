...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      'en-US': '/en-US/PrivacyPolicy',
      'es-ES': '/es-ES/PrivacyPolicy',
    },
  },
};
  ...
  return (
    <div className="relative">
      <div className="mx-auto max-w-3xl p-2 text-white">
        ...
        <h2 className="my-1 mt-3 font-bold">Definitions</h2>
        ...
        <h2 className="my-1 font-bold">Types of Data Collected</h2>
        <h3 className="mt-3 text-xl font-medium">Personal Data</h3>
        <p>
        ...
        <h3 className="mt-3 text-xl font-medium">Usage Data</h3>
        ...
        <h2 className="my-1 font-bold">Use of Your Personal Data</h2>
        ...
        <h2 className="my-1 font-bold">Retention of Your Personal Data</h2>
        <p>
        ...
        <h2 className="my-1 font-bold">Transfer of Your Personal Data</h2>
        <p>
        ...
        <h2 className="my-1 font-bold">Delete Your Personal Data</h2>
        <p>
        ...
        <h2 className="my-1 font-bold">Disclosure of Your Personal Data</h2>
        <h3 className="mt-3 text-xl font-medium">Business Transactions</h3>
        <p>
        ...
        <h3 className="mt-3 text-xl font-medium">Law enforcement</h3>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="mt-3 text-xl font-medium">Other legal requirements</h3>
        <p>
        ...
        <h2 className="my-1 font-bold">Security of Your Personal Data</h2>
        <p>
        ...
        <h1 className="mt-6 text-2xl font-bold">Children&apos;s Privacy</h1>
        <p>
